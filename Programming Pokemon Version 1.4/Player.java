...
public class Player extends Actor
{
     ...
     */
     ...
     String key = "d";
     public GreenfootImage  runForward[] = new GreenfootImage[]{new GreenfootImage("forward1.png"), new GreenfootImage("forward2.png"), new GreenfootImage("forward3.png"), 
     ...
     public GreenfootImage runBackward[] = new GreenfootImage[]{new GreenfootImage("backward1.png"), new GreenfootImage("backward2.png"), new GreenfootImage("backward3.png"),
