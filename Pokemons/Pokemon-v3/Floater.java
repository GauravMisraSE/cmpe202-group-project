...
public class Floater extends Platform
{
    ...
    {
        if(getX() < 10 || getX() > getWorld().getWidth() - 10) speed *= -1; //Example of Selection
    }   
    
    public void move()
    {
        Actor ground = getOneObjectAtOffset(lookForEdge, lookForGroundDistance, Platform.class);
        if(ground == null) speed *= -1; else move(speed); //Example of Selection
    }
    ...
    public boolean checkRightWalls()
    {
        ...
        if(rightWall == null) return false; //Example of Selection
    ...
    public boolean checkLeftWalls()
    {
        ...
        if(leftWall == null) return false; //Example of Selection
    ...
    {
        if (canSee(Player.class) ) //Example of Selection
        {
            //Hold Player Up
        }
    }
